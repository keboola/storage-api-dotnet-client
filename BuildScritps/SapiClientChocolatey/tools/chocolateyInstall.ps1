...
$packageName = 'SapiClient' # arbitrary name for the package, used in messages
$installerType = 'exe' #only one of these: exe, msi, msu
$url = 'https://keboola-sapi-dotnet-client.s3.amazonaws.com/builds/sapi-client.zip' # download url
$url64 = 'https://keboola-sapi-dotnet-client.s3.amazonaws.com/builds/sapi-client.zip' # 64bit URL here or remove - if installer decides, then use $url
